...
| [`create-release`](create-release/) | Start the next quarterly release: create the Release issue + `Bugs <version>` tech-epic in `ilm`, set their Project #5 fields, compute the sprint schedule, and verify the manual Sprint/Version UI steps. | Creates two issues and sets their fields (on confirm); never rewrites Sprint/Version field configuration. |
